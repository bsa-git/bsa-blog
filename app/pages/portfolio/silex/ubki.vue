<template>
    <v-layout row wrap>
        <v-flex xs12 sm9 offset-sm1>
            ...
            <p class="date-publication">2017-11-16</p>
            <v-card class="blog-post">
                <v-card-text>
                    <section>
                        <h1>Введение.</h1>
                        <p>
                            Приложение на базе SILEX (PHP микро-фреймворка,
                            созданного на основе Symfony2 компонентов). Используется как консольное приложение для работы
                            с сервисом <a href="http://ubki.ua/ru" target="_blank">UBKI</a> «Украинское бюро кредитных историй».
                            WEB приложение используется для тестирования консольного приложения.
                            С документацией по SILEX можно познакомиться <a href="http://silex.sensiolabs.org"
                        ...
                        <p class="subheading">
                            <strong>
                                Этот проект на <strong>GitHub</strong> можно посмотреть <a
                                    href="https://github.com/bsa-git/silex-ubki" target="_blank">здесь</a>
                            </strong>
                        </p>
                        <p class="subheading">
                            <strong>
                    ...
                    <section>
                        <h2>Ресурсы</h2>
                        <dl>
                            <dt><strong>Сервис UBKI «Украинское бюро кредитных историй»</strong></dt>
                            <dd><a href="http://ubki.ua/ru" target="_blank">Сайт</a></dd>
                            <dd>
                                <a href="https://secure.ubki.ua/upload/in/testreestrs.php" target="_blank">Тестовый сервер</a>
                            </dd>
                    ...
                    <section>
                        ...
                        <p>
                            Основное назначение данного приложения является работа с сервисом
                            <a href="http://ubki.ua/ru" target="_blank">UBKI</a> «Украинское бюро кредитных историй».
                        </p>
                        <p>
                            Предметом деятельности&nbsp;<b>ООО «Украинское бюро кредитных историй»</b>
                            &nbsp;является ведение кредитных историй (деятельность бюро по сбору, обработке, хранению,
                            защите, использованию информации, которая составляет кредитную историю) и предоставление услуг,
                            связанных с обработкой и анализом этой информации.
                        </p>
                        <p>Кроме того,&nbsp;<b>«Украинское бюро кредитных историй»</b>&nbsp;осуществляет деятельность по таким направлениям:</p>
                        <ul>
                            <li>предоставление услуг, связанных с обработкой и анализом информации, которая составляет кредитную историю;</li>
                            <li>предоставление физическим и юридическим лицам консультационных услуг, связанных с основной деятельностью Бюро;</li>
                            <li>сбор, обработка, использование информации, которая составляет кредитную историю;</li>
                            <li>предоставление кредитных отчетов;</li>
                            <li>хранение информации, составляющей кредитную историю;</li>
                            <li>предоставление кредитных отчетов в форме рассчитанного кредитного рейтинга субъекта кредитной истории и проч.</li>
                        </ul>
                        <h3>Основные характеристики приложения:</h3>
                        <ul>
                            <li>реализует консольное приложение для работы с сервисом <a href="http://ubki.ua/ru" target="_blank">UBKI</a>;
                            ...
                            <li>веб приложение используется для тестирования консольного приложения;</li>
                            <li>
                        ...
                        <ul>
                            <li><a href="http://php.net">PHP</a> version &gt;= 5.4</li>
                        ...
                        <h3>Развертывание</h3>
                        <ol>
                            <li>Клонировать <a href="https://github.com/bsa-git/silex-ubki"
                                               target="_blank">silex-ubki</a>
                                проект с помощью github.
                            </li>
                    ...
                    <section>
                        ...
                        <p><strong>Silex-UBKI</strong> проект имеет файловую структуру, показанную ниже см. пр.2.</p>
                        <kbd>пр.2</kbd>
                        <ubki-code2></ubki-code2>
                        <p>
                            <strong>Silex-UBKI</strong> состоит из двух независимых приложений. Это <strong>Веб приложение</strong>
                        ...
                        <ul>
                            <li><strong>Bootstrap</strong>
                                является самым популярным HTML, CSS, JS фреймворком для создания гибких, мобильных проектов в интернете.
                            </li>
                            <li><strong>Font Awesome</strong>
                                дает вам масштабируемые векторные иконки, которые мгновенно могут быть настроены - по размеру, цвету и всему, что может быть сделано с помощью CSS.
                            </li>
                            <li><strong>Google fonts</strong>
                                Фонты, с помощью которых можно отображать текст на вашем сайте.
                            </li>
                        ...
                        <p>Использует <code>Symfony 2</code> <a
                                href="http://symfony.com/doc/current/components/console/index.html" target="_blank">компоненты</a>,
                            которые облегчают создание удобного интерфейса командной строки см. пр4.</p>
                        <kbd>пр.4</kbd>
                        <ubki-code4></ubki-code4>
...
<script>
    ...
    import UbkiCode1 from '~components/portfolio/silex/ubki/code-1.vue'
    import UbkiCode2 from '~components/portfolio/silex/ubki/code-2.vue'
    import UbkiCode3 from '~components/portfolio/silex/ubki/code-3.vue'
    import UbkiCode4 from '~components/portfolio/silex/ubki/code-4.vue'
    import UbkiCode5 from '~components/portfolio/silex/ubki/code-5.vue'
    import UbkiCode6 from '~components/portfolio/silex/ubki/code-6.vue'
    ...
    export default {
        ...
        data() {
            return {
                title: 'Silex UBKI',
                description: 'Выполнено на базе SILEX (PHP микро-фреймворка) работающее как консольное приложение.',
            }
        },
        head() {
            return {
